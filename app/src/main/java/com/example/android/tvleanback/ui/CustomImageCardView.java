 ...
 * {@link CustomImageCardView} is highly customizable and can be used for various use-cases by adjusting
 ...
 * You can do this by using a the {@link #CustomImageCardView(Context)} constructor and passing a
...
public class CustomImageCardView extends BaseCardView {
    ...
    private void buildImageCardView(AttributeSet attrs, int defStyleAttr, int defStyle) {
        ...
        inflater.inflate(com.example.android.tvleanback.R.layout.custom_image_card_view, this);
        ...
        // Create children
        if (hasTitle) {
            mTitleView = (TextView) inflater.inflate(com.example.android.tvleanback.R.layout.custom_image_card_view_themed_title,
                    mInfoArea, false);
